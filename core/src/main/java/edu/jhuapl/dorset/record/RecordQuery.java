...
/**
 * Query object for records
 *
 * Provides methods for setting filters on the stored records. The filters supported are
 * <ul>
 * <li>Limit on the number of records returned
 * <li>Agent names
 * <li>Date range
 * </ul>
 * 
